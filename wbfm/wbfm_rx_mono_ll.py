...
class wbfm_rx_mono_ll(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, centre_freq=int(100e6), ip_arg='localhost', port_arg=int(2e3), samp_rate=int(10e6), signal_freq=int(103.5e6)):
        ...
        self.analog_fm_deemph_0 = analog.fm_deemph(fs=(samp_rate / decim / decim_2), tau=(50e-6))
    ...
    def set_audio_samp_rate(self, audio_samp_rate):
        with self._lock:
            ...
            self.set_audio_decim(int(self.samp_rate / self.decim / self.decim_2 / self.audio_samp_rate))
            self.high_pass_filter_0.set_taps(firdes.high_pass(1, self.audio_samp_rate, 100, 5, window.WIN_HAMMING, 6.76))
...
def argument_parser():
    ...
    parser.add_argument(
        "-f", "--signal-freq", dest="signal_freq", type=eng_float, default=eng_notation.num_to_str(float(int(103.5e6))),
